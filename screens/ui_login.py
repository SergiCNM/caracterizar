...
"}")
        ...
        self.radioDefault = QRadioButton(self.centralwidget)
        self.radioDefault.setObjectName(u"radioDefault")
        self.radioDefault.setGeometry(QRect(170, 220, 250, 24))
        self.radioDefault.setStyleSheet(u"QRadioButton { color: #f8f8f2; font: 10pt \"Segoe UI\"; }"
                                        u"QRadioButton::indicator { width: 16px; height: 16px; }")
        self.radioDefault.setChecked(True)
        self.radioUser = QRadioButton(self.centralwidget)
        self.radioUser.setObjectName(u"radioUser")
        self.radioUser.setGeometry(QRect(170, 250, 250, 24))
        self.radioUser.setStyleSheet(u"QRadioButton { color: #f8f8f2; font: 10pt \"Segoe UI\"; }"
                                      u"QRadioButton::indicator { width: 16px; height: 16px; }")
        self.radioUser.setChecked(False)
        self.password = QLineEdit(self.centralwidget)
        self.password.setObjectName(u"password")
        self.password.setGeometry(QRect(170, 420, 250, 30))
...
"border-radius:10px;")
        ...
        self.username.setGeometry(QRect(170, 350, 250, 30))
...
"border-radius:10px;")
        ...
        self.label_2.setGeometry(QRect(210, 316, 211, 30))
...
"")
        self.label_6.setPixmap(QPixmap(u"screens/images/wafer_64_gris.png"))
        self.version = QLabel(self.centralwidget)
        self.version.setObjectName(u"version")
        self.version.setGeometry(QRect(490, 620, 100, 24))
...
"")
        ...
        self.label_8.setGeometry(QRect(171, 315, 32, 32))
        self.label_8.setMinimumSize(QSize(32, 32))
        self.label_8.setPixmap(QPixmap(u"screens/images/icons8-user-32.png"))
        self.label_9 = QLabel(self.centralwidget)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(171, 387, 32, 32))
        self.label_9.setMinimumSize(QSize(32, 32))
        self.label_9.setPixmap(QPixmap(u"screens/images/icons8-password-window-32.png"))
        self.btnToggle = QPushButton(self.centralwidget)
        self.btnToggle.setObjectName(u"btnToggle")
        self.btnToggle.setEnabled(True)
        self.btnToggle.setGeometry(QRect(430, 404, 48, 48))
        self.btnToggle.setMinimumSize(QSize(0, 0))
        self.btnToggle.setMaximumSize(QSize(48, 48))
        self.btnToggle.setStyleSheet(u"qproperty-icon: url(screens/images/icons8-password-48.png);\n"
"\n"
"")
        self.btnToggle.setIconSize(QSize(48, 48))
        self.btnToggle.setFlat(True)
        self.lblStatus_login = QLabel(self.centralwidget)
        self.lblStatus_login.setObjectName(u"lblStatus_login")
        self.lblStatus_login.setGeometry(QRect(80, 530, 440, 60))
        self.lblStatus_login.setMinimumSize(QSize(440, 60))
        self.lblStatus_login.setMaximumSize(QSize(440, 60))
        self.lblStatus_login.setStyleSheet(u"color: #ff5555; font: 8pt \"Segoe UI\";")
        self.lblStatus_login.setAlignment(Qt.AlignCenter)
        self.lblStatus_login.setWordWrap(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioDefault.setText(QCoreApplication.translate("MainWindow", u"Enter as default user", None))
        self.radioUser.setText(QCoreApplication.translate("MainWindow", u"Enter with username and password", None))
