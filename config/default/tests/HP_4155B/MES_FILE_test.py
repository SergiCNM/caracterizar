...
def load_MES_parameters():
	...
	filename_config = os.getcwd() + base_dir + tests_dir + '/HP_4155B/MES_FILE.toml'
...
if MES_parameters["TEST_NAMES"] == "":
	...
	txt_result = "ERROR: No test names defined in MES_FILE.toml"
	...
	if cartographic_measurement:
		if str(dieActual)=="1" and str(moduleActual)=="1":
			...
			#     self,
			#     "Init MES file!",
			#     "Please, load mes file manually. When done press button Yes!",
			#     buttons=QMessageBox.Yes | QMessageBox.Cancel ,
			#     defaultButton=QMessageBox.Yes,
			# )
			retval = message_user(main, "Init MES file!", "Please, load mes file manually. When done press button Yes!", "yes_cancel")
