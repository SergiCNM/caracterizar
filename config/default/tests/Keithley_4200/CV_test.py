# Test CV in Keithley 4200 instrument
...
def load_CV_parameters():
    ...
    filename_config = os.getcwd() + base_dir + tests_dir + '/Keithley_4200/CV.toml'
    ...
    if cartographic_measurement:
        ...
        if test_status.status=="STARTED":
            ...
            if k4200.config_CV(CV_parameters):
                ...
                voltage, capacitance, conductance = k4200.measure_CV(CV_parameters, timeout, CV_parameters["HYSTERESIS"])
                ...
                if CV_parameters["HYSTERESIS"]:
                    ...
                    voltage_h, capacitance_h, conductance_h = k4200.measure_CV(CV_parameters, timeout, False)
