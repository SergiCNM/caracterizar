...
class BASIC(FPDF):
    ...
    def header(self, title="BASIC REPORT"):
    ...
    def print_report(self, wafer):
        ...
        # table conditions
        units = dict()
        units["2puntes"] = {"START": "A", "STOP": "A", "STEP": "A", "COMPLIANCE": "V"}
        units["4puntes"] = {"START": "A", "STOP": "A", "STEP": "A", "COMPLIANCE": "V"}
        y = y + 20
        self.table_conditions("2puntes", wafer, 10, y, units)
        self.table_conditions("4puntes", wafer, 80, y, units)
    ...
    def print_mapa_wafer(self):
        ...
        zero_values = [
            ...
            [26, 0], [26, 1], [26, 9], \
            [27, 0], [27, 1], [27, 9], \
            [28, 0], [28, 1], [28, 2], [28, 8], [28, 9], \
            [29, 0], [29, 1], [29, 2], [29, 8], [29, 9], \
            [30, 0], [30, 1], [30, 2], [30, 3], [30, 7], [30, 8], [30, 9] \
            ]
    ...
    def numpy_array_print_to_wafer(self, np_array, estadistica_param, left=True):
        ...
        width_cell = round((self.WIDTH / 2.5) / cols_num)
        height_cell = round((self.WIDTH / 2.5) / rows_num)
