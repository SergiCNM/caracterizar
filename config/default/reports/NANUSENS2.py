...
class NANUSENS2(FPDF):
                        ...
                        for filedata in os.listdir(path_data):
                            ...
                            if os.path.isfile(namefile):
                                ...
                                if "CV" in filedata:
                                    ...
                                    text_plot = filedata.replace("_1.txt", "") + " DIE_01-01_DUT1"
                                    if filedata.endswith("_1.txt"):
                                        text_plot = filedata.replace("_1.txt", "") + " DIE_01-01_DUT1"
                                    elif filedata.endswith("_2.txt"):
                                        text_plot = filedata.replace("_2.txt", "") + " DIE_01-01_DUT4"
                                    elif filedata.endswith("_3.txt"):
                                        text_plot = filedata.replace("_3.txt", "") + " DIE_01-02_DUT1"
                                    elif filedata.endswith("_4.txt"):
                                        text_plot = filedata.replace("_4.txt", "") + " DIE_01-02_DUT2"
                                    elif filedata.endswith("_5.txt"):
                                        text_plot = filedata.replace("_5.txt", "") + " DIE_01-03_DUT1"
                                    elif filedata.endswith("_6.txt"):
                                        text_plot = filedata.replace("_6.txt", "") + " DIE_01-03_DUT4"
                                    elif filedata.endswith("_7.txt"):
                                        text_plot = filedata.replace("_7.txt", "") + " DIE_01-04_DUT1"
                                    elif filedata.endswith("_8.txt"):
                                        text_plot = filedata.replace("_8.txt", "") + " DIE_01-04_DUT2"
                                    elif filedata.endswith("_9.txt"):
                                        text_plot = filedata.replace("_9.txt", "") + " DIE_01-05_DUT1"
                                    elif filedata.endswith("_10.txt"):
                                        text_plot = filedata.replace("_10.txt", "") + " DIE_01-05_DUT4"
                                    elif filedata.endswith("_11.txt"):
                                        text_plot = filedata.replace("_11.txt", "") + " DIE_01-06_DUT1"
                                    elif filedata.endswith("_12.txt"):
                                        text_plot = filedata.replace("_12.txt", "") + " DIE_01-06_DUT4"
                                    elif filedata.endswith("_13.txt"):
                                        text_plot = filedata.replace("_13.txt", "") + " DIE_01-07_DUT1"
                                    elif filedata.endswith("_14.txt"):
                                        text_plot = filedata.replace("_14.txt", "") + " DIE_01-07_DUT4"
                                    elif filedata.endswith("_15.txt"):
                                        text_plot = filedata.replace("_15.txt", "") + " DIE_01-08_DUT1"
                                    elif filedata.endswith("_16.txt"):
                                        text_plot = filedata.replace("_16.txt", "") + " DIE_01-08_DUT4"
                                    elif filedata.endswith("_17.txt"):
                                        text_plot = filedata.replace("_17.txt", "") + " DIE_01-09_DUT1"
                                    elif filedata.endswith("_18.txt"):
                                        text_plot = filedata.replace("_18.txt", "") + " DIE_01-09_DUT4"
                                    elif filedata.endswith("_19.txt"):
                                        text_plot = filedata.replace("_19.txt", "") + " DIE_01-10_DUT1"
                                    elif filedata.endswith("_20.txt"):
                                        text_plot = filedata.replace("_20.txt", "") + " DIE_01-10_DUT4"
                                    elif filedata.endswith("_21.txt"):
                                        text_plot = filedata.replace("_21.txt", "") + " DIE_01-11_DUT1"
                                    elif filedata.endswith("_22.txt"):
                                        text_plot = filedata.replace("_22.txt", "") + " DIE_01-11_DUT4"
                                    ...
                                    plt.clf()
                                    # copy first image (counter=0) to root path (dir_wafer) with name ="CV_" + filedata.split("")[-1] + ".png"
                                    print(f"filedata: {filedata}")
                                    print(f"textplot: {text_plot}")
                                    print("CV_" + text_plot.split(" ")[-1] + ".png")
                                    print("-------------------------------")
                                    if re.search(r'_1_\d+\.txt$', filedata):
                                        print("Name file: CV_" + text_plot.split(' ')[-1] + ".png")
                                        print("-------------------------------")
                                        shutil.copy(str(namefile_plot),
                                                    os.path.join(dir_wafer,
                                                                 "CV_" + text_plot.split(" ")[-1] + ".png"
                                                                 )
                                                    )
                                    counter += 1
    ...
    def get_estepa_configuration_toml(self, wafer, module_name, parameter):
        estepa_configuration = self.config["estepa"]
        if len(self.config_estepa_toml) != 0:
            if self.run in self.config_estepa_toml and wafer in self.config_estepa_toml[self.run] and module_name in \
                    self.config_estepa_toml[self.run][wafer] and parameter in self.config_estepa_toml[self.run][wafer][module_name]:
                estepa_configuration = self.config_estepa_toml[self.run][wafer][module_name][parameter]
    ...
    def print_report(self, wafer):
        ...
        estadistica = dict()
        estadistica["DIE_01-01_DUT1-4"] = dict()
        estadistica["DIE_01-02_DUT1-2"] = dict()
        estadistica["DIE_01-03_DUT1-4"] = dict()
        estadistica["DIE_01-04_DUT1-2"] = dict()
        estadistica["DIE_01-05_DUT1-4"] = dict()
        estadistica["DIE_01-06_DUT1-4"] = dict()
        estadistica["DIE_01-07_DUT1-4"] = dict()
        estadistica["DIE_01-08_DUT1-4"] = dict()
        estadistica["DIE_01-09_DUT1-4"] = dict()
        estadistica["DIE_01-10_DUT1-4"] = dict()
        estadistica["DIE_01-11_DUT1-4"] = dict()
        estadistica["DIE_01-01_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-01_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-01_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-02_DUT1-2"]["Coff"] = None
        estadistica["DIE_01-02_DUT1-2"]["Vpullin"] = None
        estadistica["DIE_01-02_DUT1-2"]["Cmax"] = None
        estadistica["DIE_01-03_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-03_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-03_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-04_DUT1-2"]["Coff"] = None
        estadistica["DIE_01-04_DUT1-2"]["Vpullin"] = None
        estadistica["DIE_01-04_DUT1-2"]["Cmax"] = None
        estadistica["DIE_01-05_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-05_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-05_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-06_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-06_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-06_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-07_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-07_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-07_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-08_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-08_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-08_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-09_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-09_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-09_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-10_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-10_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-10_DUT1-4"]["Cmax"] = None
        estadistica["DIE_01-11_DUT1-4"]["Coff"] = None
        estadistica["DIE_01-11_DUT1-4"]["Vpullin"] = None
        estadistica["DIE_01-11_DUT1-4"]["Cmax"] = None
        ...
        estadistica_wafermap["DIE_01-01_DUT1"] = dict()
        estadistica_wafermap["DIE_01-01_DUT4"] = dict()
        estadistica_wafermap["DIE_01-02_DUT1"] = dict()
        estadistica_wafermap["DIE_01-02_DUT2"] = dict()
        estadistica_wafermap["DIE_01-03_DUT1"] = dict()
        estadistica_wafermap["DIE_01-03_DUT4"] = dict()
        estadistica_wafermap["DIE_01-04_DUT1"] = dict()
        estadistica_wafermap["DIE_01-04_DUT2"] = dict()
        estadistica_wafermap["DIE_01-05_DUT1"] = dict()
        estadistica_wafermap["DIE_01-05_DUT4"] = dict()
        estadistica_wafermap["DIE_01-06_DUT1"] = dict()
        estadistica_wafermap["DIE_01-06_DUT4"] = dict()
        estadistica_wafermap["DIE_01-07_DUT1"] = dict()
        estadistica_wafermap["DIE_01-07_DUT4"] = dict()
        estadistica_wafermap["DIE_01-08_DUT1"] = dict()
        estadistica_wafermap["DIE_01-08_DUT4"] = dict()
        estadistica_wafermap["DIE_01-09_DUT1"] = dict()
        estadistica_wafermap["DIE_01-09_DUT4"] = dict()
        estadistica_wafermap["DIE_01-10_DUT1"] = dict()
        estadistica_wafermap["DIE_01-10_DUT4"] = dict()
        estadistica_wafermap["DIE_01-11_DUT1"] = dict()
        estadistica_wafermap["DIE_01-11_DUT4"] = dict()
        estadistica_wafermap["DIE_01-01_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-01_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-01_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-01_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-01_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-01_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-02_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-02_DUT2"]["Coff"] = None
        estadistica_wafermap["DIE_01-02_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-02_DUT2"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-02_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-02_DUT2"]["Cmax"] = None
        estadistica_wafermap["DIE_01-03_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-03_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-03_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-03_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-03_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-03_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-04_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-04_DUT2"]["Coff"] = None
        estadistica_wafermap["DIE_01-04_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-04_DUT2"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-04_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-04_DUT2"]["Cmax"] = None
        estadistica_wafermap["DIE_01-05_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-05_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-05_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-05_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-05_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-05_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-06_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-06_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-06_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-06_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-06_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-06_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-07_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-07_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-07_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-07_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-07_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-07_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-08_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-08_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-08_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-08_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-08_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-08_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-09_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-09_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-09_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-09_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-09_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-09_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-10_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-10_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-10_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-10_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-10_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-10_DUT4"]["Cmax"] = None
        estadistica_wafermap["DIE_01-11_DUT1"]["Coff"] = None
        estadistica_wafermap["DIE_01-11_DUT4"]["Coff"] = None
        estadistica_wafermap["DIE_01-11_DUT1"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-11_DUT4"]["Vpullin"] = None
        estadistica_wafermap["DIE_01-11_DUT1"]["Cmax"] = None
        estadistica_wafermap["DIE_01-11_DUT4"]["Cmax"] = None
        ...
        if not result_file.error:
            ...
            for die in result_file.dies:
                for module in result_file.modules:
                    ...
                    where = "DIE_01-01_DUT1-4"
                    where_wafermap = "DIE_01-01_DUT1"
                    match module:
                        case "(1)":
                            where = "DIE_01-01_DUT1-4"
                            where_wafermap = "DIE_01-01_DUT1"
                        case "(2)":
                            where = "DIE_01-01_DUT1-4"
                            where_wafermap = "DIE_01-01_DUT4"
                        case "(3)":
                            where = "DIE_01-02_DUT1-2"
                            where_wafermap = "DIE_01-02_DUT1"
                        case "(4)":
                            where = "DIE_01-02_DUT1-2"
                            where_wafermap = "DIE_01-02_DUT2"
                        case "(5)":
                            where = "DIE_01-03_DUT1-4"
                            where_wafermap = "DIE_01-03_DUT1"
                        case "(6)":
                            where = "DIE_01-03_DUT1-4"
                            where_wafermap = "DIE_01-03_DUT4"
                        case "(7)":
                            where = "DIE_01-04_DUT1-2"
                            where_wafermap = "DIE_01-04_DUT1"
                        case "(8)":
                            where = "DIE_01-04_DUT1-2"
                            where_wafermap = "DIE_01-04_DUT2"
                        case "(9)":
                            where = "DIE_01-05_DUT1-4"
                            where_wafermap = "DIE_01-05_DUT1"
                        case "(10)":
                            where = "DIE_01-05_DUT1-4"
                            where_wafermap = "DIE_01-05_DUT4"
                        case "(11)":
                            where = "DIE_01-06_DUT1-4"
                            where_wafermap = "DIE_01-06_DUT1"
                        case "(12)":
                            where = "DIE_01-06_DUT1-4"
                            where_wafermap = "DIE_01-06_DUT4"
                        case "(13)":
                            where = "DIE_01-07_DUT1-4"
                            where_wafermap = "DIE_01-07_DUT1"
                        case "(14)":
                            where = "DIE_01-07_DUT1-4"
                            where_wafermap = "DIE_01-07_DUT4"
                        case "(15)":
                            where = "DIE_01-08_DUT1-4"
                            where_wafermap = "DIE_01-08_DUT1"
                        case "(16)":
                            where = "DIE_01-08_DUT1-4"
                            where_wafermap = "DIE_01-08_DUT4"
                        case "(17)":
                            where = "DIE_01-09_DUT1-4"
                            where_wafermap = "DIE_01-09_DUT1"
                        case "(18)":
                            where = "DIE_01-09_DUT1-4"
                            where_wafermap = "DIE_01-09_DUT4"
                        case "(19)":
                            where = "DIE_01-10_DUT1-4"
                            where_wafermap = "DIE_01-10_DUT1"
                        case "(20)":
                            where = "DIE_01-10_DUT1-4"
                            where_wafermap = "DIE_01-10_DUT4"
                        case "(21)":
                            where = "DIE_01-11_DUT1-4"
                            where_wafermap = "DIE_01-11_DUT1"
                        case "(22)":
                            where = "DIE_01-11_DUT1-4"
                            where_wafermap = "DIE_01-11_DUT4"
            ...
            for module_name in parameters_file_list:
                ...
                for parameter in parameters_file_list[module_name]:
                    estepa_configuration = self.get_estepa_configuration_toml(wafer, module_name, parameter)
                ...
                y = y + 20
                # put only graph DUT1
                image_CV = os.path.join(wafer_path, "CV_" + module_name.replace("DUT1-4", "DUT1").replace("DUT1-2", "DUT1") + ".png")
                if os.path.exists(image_CV):
                    self.image(image_CV, x, y, 90)
                    # print table
                    self.table_conditions("CV", wafer, 120, y, units)
                    y = y + 75
                # second image DUT4 or DUT2
                image_CV = os.path.join(wafer_path, "CV_" + module_name.replace("DUT1-4", "DUT4").replace("DUT1-2", "DUT2") + ".png")
                if os.path.exists(image_CV):
                    self.image(image_CV, x, y, 90)
            ...
            for module_name_wafermap in parameters_file_list_wafermap:
                for parameter_wafermap in parameters_file_list_wafermap[module_name_wafermap]:
                    estepa_configuration = self.get_estepa_configuration_toml(wafer, module_name_wafermap, parameter_wafermap)
