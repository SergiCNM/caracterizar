...
real_origin_chip = "-5 -3"
origin_chip = "0 0" # normaly start with 0,0
home_chip = "-1 2" # home (0um , 0um) could be different to origin (first die to measure)
...
# wafer positions
wafer_positions = ['0 0', '-6 0', '-3 -5', '0 -10', '-6 -10']
